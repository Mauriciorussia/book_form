			...
			<div class="book-form-container">
				<form class="book-form" method="POST">
					...
					<div class="res-editors">
						<label for="editor"><?php esc_html_e('Responsible editors', 'maurl-book-form'); ?></label>
					...
					<div class="full_name">
						<label for="full_name"><?php esc_html_e('Full Name of The Work', 'maurl-book-form'); ?></label>
						<input type="text"  id="full_name">
					</div>
					<div class="edition-type">
						<label for="edition-type"><?php esc_html_e('Edition Type', 'maurl-book-form'); ?></label>
					...
					<div class="volume_lines">
						<label for="volume_lines"><?php esc_html_e('Lines', 'maurl-book-form'); ?></label>
						<input type="number" name="volume_lines" id="volume_lines">
					</div>
					<div class="book_format">
						<label for="book_format"><?php esc_html_e('Book Format', 'maurl-book-form'); ?></label>
					...
					<div class="circulations">
						<label for="circulations"><?php esc_html_e('Circulations (Copies)', 'maurl-book-form'); ?></label>
						<input type="number" id="circulations">
					</div>
					<div class="neck">
						<label for="neck"><?php esc_html_e('Neck specified in the book', 'maurl-book-form'); ?></label>
						<input type="text" id="neck">
					</div>
					<div class="city-publisher">
						<label for="city-publisher"><?php esc_html_e('City: Publisher, Year of issue', 'maurl-book-form'); ?></label>
					...
					<div class="MPF">
					<label for="MPF"><?php esc_html_e('Manuscript preparation form', 'maurl-book-form'); ?></label>
					...
					<div class="funding-source">
						<label for="funding-source"><?php esc_html_e('Funding source', 'maurl-book-form'); ?></label>
						<input type="text"  id="funding-source">
					</div>

					<div class="budget">
						<label for="budget"><?php esc_html_e('Amount of budget expenditures', 'maurl-book-form'); ?></label>
						<input type="text"  id="budget">
					</div>

					<div class="IPM-available">
						<label for="IPM-available"><?php esc_html_e('Availability in the IPM FEB RAS library', 'maurl-book-form'); ?></label>
						<input type="checkbox" name="IPM_availability" id="IPM_availability">
					</div>
					
					<div class="book-link">
						<label for="book-link"><?php esc_html_e('Link to an electronic resource', 'maurl-book-form'); ?></label>
						<input type="text" id="book-link">
					</div>
					<div class="book-notes">
						<label for="book-notes"><?php esc_html_e('Book Notes', 'maurl-book-form'); ?></label>
